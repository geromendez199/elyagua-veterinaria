        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6 mb-10">
          ...
          <div>
            ...
            <ul className="text-sm space-y-2.5 text-gray-300">
              ...
              <li><Link href="/info" className="hover:text-primary transition">Consejos Veterinarios</Link></li>
              <li><Link href="/quienes-somos" className="hover:text-primary transition">Quiénes Somos</Link></li>
