        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
            ...
            <div className="hidden md:flex gap-8 items-center">
              {searchOpen ? (
                ...
                <>
                  ...
                  <Link href="/info" className="hover:text-primary-light transition font-medium">Consejos</Link>
          ...
          {menuOpen && (
            <div className="md:hidden mt-3 pb-3 border-t border-white/20 flex flex-col gap-1 pt-3">
              ...
              <Link href="/info" onClick={() => setMenuOpen(false)} className="py-2 px-2 rounded hover:bg-white/10 font-medium transition">Consejos</Link>
